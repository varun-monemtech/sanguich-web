	...
	return (
		<>
			...
			<Transition
				...
				nodeRef={nodeRef2}
			>
				<div ref={nodeRef2} className={`frs-grid-full header-bar-new rounded-b-[37px] drop-shadow-[0_3px_6px_rgba(0,0,0,0.16)] c5 !bg-[#D0C8B9] ${naviContext.windowSize?.mobile ? 'onmobile' : ''} ${naviContext.isHamburgerActive ? 'open inview' : ''}`}>
