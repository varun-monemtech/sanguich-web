			...
			<div className="form-cut-off">
				...
				>
					...
					<div className={`span-12 grid-12 form-fields-wrap active`}>
						...
						<label className="span-12 animated delay-500">
							<input type="text" placeholder="Enter phone" name="phone" ref={register({required: false, maxLength: 80, message: "error message"})} />
							{errors.name && <p className="small margin-off">your phone is required.</p>}
						</label>
						<label className="span-12 animated delay-500">
