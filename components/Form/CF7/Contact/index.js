...
function CF7Contact(props) {
	...
	const { register, handleSubmit, control, formState: { errors }, reset } = useForm({reValidateMode: 'onChange'})
	...
	const onSubmit = (form, e) => {
		...
		const url = 'https://cms.sanguich.com/wp-json/contact-form-7/v1/contact-forms/817/feedback'
			...
			<div className="form-cut-off">
				...
				>
					...
					<div className="decor-wrap">
						...
						<div className={`arrow-up animated delay-1000 active`} onClick={(e) => onClickFillThisForm(e)}></div>
					...
					<div className="span-12 text-center fill-this-form animated delay-500" onClick={(e) => onClickFillThisForm(e)}><h3>Contact Us</h3><p>You can also reach us by phone at <a href="tel:3055390969">305-539-0969</a>. Looking forward to hearing from you.</p></div>
					...
					<div className={`span-12 grid-12 form-fields-wrap active`}>
						...
						<label className="span-12 animated delay-500">
							<input type="text" placeholder="Enter phone" name="phone" {...register("phone",{required: false})} />
						...
						<label className="span-12 animated delay-500">
							<textarea placeholder="message" name="message" {...register("message",{required: false, message: "error message"})} />
						</label>
