...
function CF7Careers() {
  ...
  const onSubmit = (form, e) => {
    ...
    const url =
      "https://cms.sanguich.com/wp-json/contact-form-7/v1/contact-forms/1004/feedback";
  ...
  return (
    <section
      ref={io}
      id={`section-careers`}
      className={`content c5 grid-12 is-inview ${ioInView ? "inview" : ""}`}
    >
          ...
          >
            ...
            <div className={`span-12 grid-12 form-fields-wrap active`}>
              ...
              <label className="elevate-z span-12 animated delay-500">
                ...
                {errors.what && (
                  <p className="small margin-off">This field is required</p>
                )}
              </label>
